...
// NewMockIf creates a new instance of MockIf. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockIf[I Event](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockIf[I] {
	mock := &MockIf[I]{}
...
// MockIf is an autogenerated mock type for the If type
type MockIf[I Event] struct {
	mock.Mock
}

type MockIf_Expecter[I Event] struct {
	mock *mock.Mock
}

func (_m *MockIf[I]) EXPECT() *MockIf_Expecter[I] {
	return &MockIf_Expecter[I]{mock: &_m.Mock}
}

// Evaluate provides a mock function for the type MockIf
func (_mock *MockIf[I]) Evaluate(ctx context.Context, event I, syms boolexpr.Symbols) (bool, error) {
	ret := _mock.Called(ctx, event, syms)
...
// MockIf_Evaluate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Evaluate'
type MockIf_Evaluate_Call[I Event] struct {
	*mock.Call
}
...
//   - event I
//   - syms boolexpr.Symbols
func (_e *MockIf_Expecter[I]) Evaluate(ctx any, event any, syms any) *MockIf_Evaluate_Call[I] {
	return &MockIf_Evaluate_Call[I]{Call: _e.mock.On("Evaluate", ctx, event, syms)}
}

func (_c *MockIf_Evaluate_Call[I]) Run(run func(ctx context.Context, event I, syms boolexpr.Symbols)) *MockIf_Evaluate_Call[I] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockIf_Evaluate_Call[I]) Return(b bool, err error) *MockIf_Evaluate_Call[I] {
	_c.Call.Return(b, err)
	return _c
}

func (_c *MockIf_Evaluate_Call[I]) RunAndReturn(run func(ctx context.Context, event I, syms boolexpr.Symbols) (bool, error)) *MockIf_Evaluate_Call[I] {
	_c.Call.Return(run)
	return _c
}
...
// The first argument is typically a *testing.T value.
func NewMockMiddleware[I Event, O Event](t interface {
	mock.TestingT
	Cleanup(func())
}) *MockMiddleware[I, O] {
...
type MockMiddleware[I Event, O Event] struct {
	mock.Mock
}

type MockMiddleware_Expecter[I Event, O Event] struct {
	mock *mock.Mock
}
...
type MockMiddleware_WrapAction_Call[I Event, O Event] struct {
	*mock.Call
}
...
type MockMiddleware_WrapCallback_Call[I Event, O Event] struct {
	*mock.Call
}
...
func (_mock *MockMiddleware[I, O]) WrapDestination(ctx context.Context, rule *Rule[I, O], destination Destination[O], out O) (Destination[O], error) {
...
type MockMiddleware_WrapDestination_Call[I Event, O Event] struct {
	*mock.Call
}
...
//   - out O
func (_e *MockMiddleware_Expecter[I, O]) WrapDestination(ctx any, rule any, destination any, out any) *MockMiddleware_WrapDestination_Call[I, O] {
	return &MockMiddleware_WrapDestination_Call[I, O]{Call: _e.mock.On("WrapDestination", ctx, rule, destination, out)}
}

func (_c *MockMiddleware_WrapDestination_Call[I, O]) Run(run func(ctx context.Context, rule *Rule[I, O], destination Destination[O], out O)) *MockMiddleware_WrapDestination_Call[I, O] {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockMiddleware_WrapDestination_Call[I, O]) RunAndReturn(run func(ctx context.Context, rule *Rule[I, O], destination Destination[O], out O) (Destination[O], error)) *MockMiddleware_WrapDestination_Call[I, O] {
	_c.Call.Return(run)
	return _c
}
